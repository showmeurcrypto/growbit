<template>
  <div
    ...
    v-bind:class="[
      ...
      'game-' +
        (battlesGameData.game !== null ? battlesGameData.game.state : ''),
    ]"
  >
    <transition name="fade" mode="out-in">
      <div
        v-if="
          socketBattles.connected === false || battlesGameData.loading === true
        "
        class="game-loading"
        key="loading"
      >
...
export default {
  ...
  methods: {
    ...mapActions(["battlesSetGameData", "battlesGetGameDataSocket"]),
  },
  computed: {
    ...mapGetters([
      "socketBattles",
    ...
    battlesGetPlayerCount() {
      ...
      if (this.battlesGameData.game !== null) {
        count = this.battlesGameData.game.playerCount;
      }
